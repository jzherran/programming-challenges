...
public class isListPalindrome {
  ...
  public static void main(String[] args) {
    ...
    ListNode<Integer> l11 = new ListNode(2);
    ListNode<Integer> l12 = new ListNode(2);
    ListNode<Integer> l13 = new ListNode(3);
    l12.next = l13;
    l11.next = l12;
    l1.next = l11;
    ...
    ListNode<Integer> l21 = new ListNode(1000000000);
    ListNode<Integer> l22 = new ListNode(-1000000000);
    ListNode<Integer> l23 = new ListNode(-1000000000);
    ListNode<Integer> l24 = new ListNode(1000000000);
    ListNode<Integer> l25 = new ListNode(1);
    l24.next = l25;
    l23.next = l24;
    l22.next = l23;
    l21.next = l22;
    ...
    System.out.println(isListPalindrome(l2));
  }

  static boolean isListPalindrome(ListNode<Integer> head) {
  ...
  static boolean compareLists(ListNode<Integer> head1, ListNode<Integer> head2) {
