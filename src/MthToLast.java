...
public class MthToLast {
    ...
    public static void main(String[] args) {
        ...
        for (String li: l) {
            DoublyLinkedNode node = new DoublyLinkedNode(null, null, BigInteger.valueOf(Long.parseLong(li)));
    ...
    static class DoublyLinkedList {
        ...
        static void insertBefore(DoublyLinkedList list, DoublyLinkedNode node, DoublyLinkedNode newNode) {
            newNode.next = node;
            if (node.prev == null)
        ...
        static void insertAfter(DoublyLinkedList list, DoublyLinkedNode node, DoublyLinkedNode newNode) {
